<!-- RULES-START -->
# Rules Data
## R1V207 – R1V207 -  Allow URI Query, URL, User Agents, and IPs (Allow)
* Action: SKIP
```
...
```
## R2V207 – R2V207 - Block URI Query, URL, User Agents, and IPs (Block)
* Action: BLOCK
```
...
```
## R3V207 – R3V207 – Managed Challenge /wp-admin (Managed Challenge)
...
```
## R4V207 – R4V207 – Challenge Outside of GEO (JS Challenge)
* Action: JS CHALLENGE
```
...
# Changelog
## Release 207
* First release from beta channel (v3 schema).
