<!-- RULES-START -->
# Rules Data
## R1V204 -  Allow URI Query, URL, User Agents, and IPs (Allow)
...
```
## R2V204 - Block URI Query, URL, User Agents, and IPs (Block)
* Action: BLOCK
```
...
```
## R3V204 – Managed Challenge /wp-admin (Managed Challenge)
...
```
## R4V204 – Challenge Outside of GEO (JS Challenge)
* Action: JS CHALLENGE
```
