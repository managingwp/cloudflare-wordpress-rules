...
```
## R3V204 – R3V204 – Managed Challenge /wp-admin (Managed Challenge)
...
```
## R4V204 – R4V204 – Challenge Outside of GEO (JS Challenge)
* Action: JS CHALLENGE
```
