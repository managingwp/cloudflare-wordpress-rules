<!-- RULES-START -->
# Rules Data
## R1Vlatest – R1VLATEST -  Allow URI Query, URL, User Agents, and IPs (Allow)
* Action: ALLOW
```
...
```
## R2Vlatest – R2VLATEST - Block URI Query, URL, User Agents, and IPs (Block)
* Action: BLOCK
```
...
```
## R3Vlatest – R3VLATEST – Managed Challenge /wp-admin (Managed Challenge)
...
```
## R4Vlatest – R4VLATEST – Challenge Outside of GEO (JS Challenge)
* Action: JS CHALLENGE
```
