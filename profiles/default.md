<!-- RULES-START -->
# Rules Data
## R1V203 – R1V203 - Block URI Query, URL, User Agents, and IPs (Block)
* Action: BLOCK
```
...
```
## R2V203 – R2V203 -  Allow URI Query, URL, User Agents, and IPs (Allow → Skip)
* Action: SKIP
```
...
```
## R3V203 – R3V203 – Managed Challenge /wp-admin (Managed Challenge)
...
```
## R4V203 – R4V203 – Challenge Outside of GEO (JS Challenge)
* Action: JS CHALLENGE
```
...
# Changelog
## Release 203
* Added useragent Infusionsoft to R2 
