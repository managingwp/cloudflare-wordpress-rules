...
```
## R3V205 – R3V205 – Managed Challenge /wp-admin (Managed Challenge)
...
```
## R4V205 – R4V205 – Challenge Outside of GEO (JS Challenge)
* Action: JS CHALLENGE
```
...
# Changelog
## Release 204 (Beta)
* Added AS396982 to the block rule (R2)
